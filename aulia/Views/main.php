    ...
    <nav>
            <div class="p-3 mb-2 bg-danger ">
                <ul class="nav justify-content-center">
                  <li class="nav-item">
                    <a class="nav-link text-light" aria-current="page" href="main.php?menu=<?php echo base64_encode('id_s') ?>">Siswa</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link text-light" href="main.php?menu=<?php echo base64_encode('id_k') ?>">Kelas</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link text-light" href="main.php?menu=<?php echo base64_encode('id_sp') ?>">SPP</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link text-light" href="main.php?menu=<?php echo base64_encode('id_pet') ?>">Petugas</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link text-light" href="main.php?menu=<?php echo base64_encode('id_pem') ?>">Pembayaran</a>
                  </li>
                </ul>
            </div>
        </nav>
